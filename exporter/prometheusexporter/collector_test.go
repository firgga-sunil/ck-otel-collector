...
// ========== ENHANCEMENT: Mock Cleanup Methods for Testing ==========

// CleanByLabels mock implementation
func (a *mockAccumulator) CleanByLabels(filters map[string]string) int {
	return 0
}

// CleanByMetricName mock implementation
func (a *mockAccumulator) CleanByMetricName(namePattern string) int {
	return 0
}

// CleanExpired mock implementation
func (a *mockAccumulator) CleanExpired() int {
	return 0
}
